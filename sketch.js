...
function setup() 
{
  ...
  star_counter = createSprite(50,20,30,30);
  star_counter.scale = 0.2;
  star_counter.addAnimation('empty',empty_star);
  star_counter.addAnimation('onestar',one_star);
  star_counter.addAnimation('twostar',two_star);
  star_counter.changeAnimation('empty');
...
function draw() 
{
  ...
  if(collide(fruit,star,20)==true){
    star.visible = false;
    star_counter.changeAnimation('onestar');
  }

  if(collide(fruit,star2,20)==true){
    star2.visible = false;
    star_counter.changeAnimation('twostar');
  }
